    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentFavLessons", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentFavLessons_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentFavLessons_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentFavLessons_LessonId",
                table: "StudentFavLessons",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentFavLessons_StudentId",
                table: "StudentFavLessons",
                column: "StudentId");
