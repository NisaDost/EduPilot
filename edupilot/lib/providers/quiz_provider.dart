...
List<Quiz> allQuizes = [
  Quiz(lesson: Lesson.math, pointPerQuestion: Lesson.math.point),
  Quiz(lesson: Lesson.geometry, pointPerQuestion: Lesson.geometry.point),
  Quiz(lesson: Lesson.physics, pointPerQuestion: Lesson.physics.point),
  ...
  Quiz(lesson: Lesson.history, pointPerQuestion: Lesson.history.point),
